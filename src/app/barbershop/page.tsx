...
export const metadata: Metadata = {
  title: "Silvia's Barbershop · Em desenvolvimento",
  description:
    "A casa masculina da família Silvia's. Plataforma online em construção. Por enquanto, agendamento pelo WhatsApp ou Instagram.",
};
          ...
          <div className="grid-editorial">
            <div className="col-span-12 lg:col-span-10 lg:col-start-2 text-center">
              ...
              <h1 className="mt-6 text-balance">
                <span className="text-display-script text-gold-gradient">Barbershop</span>{" "}
                em breve.
              </h1>

              <p className="mt-8 max-w-[48ch] mx-auto text-[16px] lg:text-[18px] text-paper-200/80 leading-[1.65]">
                A casa masculina da família Silvia&rsquo;s ganhará sua própria
                plataforma online em breve. Por enquanto, agendamentos pelo
                Instagram ou WhatsApp.
              </p>

              <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-3">
                <Button
                  href="https://instagram.com/silviasbarbershop"
                  target="_blank"
                  variant="gold"
                  size="md"
                >
